...
input_field.pack(ipady = 30)    # 'ipady' : internal padding 
...
choices = { 'Basic','Advanced','Matrix','Function'}
tkvar.set('Basic') # set the default option

popupMenu = OptionMenu(mainframe, tkvar, *choices)
Label(mainframe, text="Modes").grid(row = 1, column = 1)
popupMenu.grid(row = 2, column =1)


# Functions

# btn_click: continuously updates the input field whenever you enter a number
def btn_click(item):
